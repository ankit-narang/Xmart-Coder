...
public interface UITextInputTokenizer 
    ...
    UITextRange rangeEnclosingPosition$withGranularity$inDirection$(UITextPosition position, UITextGranularity granularity, @NSInteger long direction);
    ...
    boolean isPosition$atBoundary$inDirection$(UITextPosition position, UITextGranularity granularity, @NSInteger long direction);
    ...
    UITextPosition positionFromPosition$toBoundary$inDirection$(UITextPosition position, UITextGranularity granularity, @NSInteger long direction);
    ...
    boolean isPosition$withinTextUnit$inDirection$(UITextPosition position, UITextGranularity granularity, @NSInteger long direction);
}
