...
@ObjCCategoryOwner("NSDictionary")
@ObjCFramework("JSONKit")
public final class NSDictionaryJSONKitCategories extends NSDictionary  {
    
    private NSDictionaryJSONKitCategories() {}
    
    
    @ObjCCategoryMethod(catname = "JSONKitSerializing", catownername = "NSDictionary")
    ...
    @ObjCCategoryMethod(catname = "JSONKitSerializingBlockAdditions", catownername = "NSDictionary")
